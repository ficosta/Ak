...
Partial Class DialogOptions
  ...
  Private WithEvents TabControlOptions As MetroFramework.Controls.MetroTabControl
  ...
  Private WithEvents MetroCheckBoxUseArabicNames As MetroFramework.Controls.MetroCheckBox
End Class
