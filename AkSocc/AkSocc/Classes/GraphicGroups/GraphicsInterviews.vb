...
Public Class GraphicsInterviews
  ...
  Public Overrides Function PrepareScene(graphicStep As GraphicStep) As Scene
    ...
    Try
      ...
      Scene = PrepareReporters(changeStep, _selectedPlayer)
  ...
  Public Function PreparePlayer(gSide As Integer, player As Player, team As Team) As Scene
    ...
    Try
      ...
      If Not player Is Nothing Then
        scene.SceneParameters.Add("Lower3rd_Single_Text_Subject_Name", VizEncoding(player.ArabicName))
        scene.SceneParameters.Add(prefix & "Bottom_Bar_Text_Text_01", VizEncoding(team.Name))
        scene.SceneParameters.Add("Lower3rd_Side_1_Bottom_Bar_Text_Text_01", VizEncoding(player.ArabicName))
        scene.SceneParameters.Add("Lower3rd_Side_2_Bottom_Bar_Text_Text_01", VizEncoding(player.ArabicName))
      End If
