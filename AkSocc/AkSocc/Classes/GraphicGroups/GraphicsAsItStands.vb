...
#Region "Full frame scenes"
  ...
  Public Function PrepareLeagueTable(gSide As Integer, isTop As Boolean, showArrows As Boolean) As Scene
    ...
    Try
      ...
      scene.SceneParameters.Add("LeftFramer_Side_" & gSide & "_Table_Text", Arabic("LEAGUE TABLE"))
      scene.SceneParameters.Add("LeftFramer_Title_Table_Side_" & gSide & "_Text_01", Arabic("LEAGUE TABLE"))
