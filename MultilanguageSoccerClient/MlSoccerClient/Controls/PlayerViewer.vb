...
#Region "Selection"
  ...
  Private Sub Label_MouseEnter(sender As Object, e As EventArgs) Handles LabelName.MouseEnter, LabelDorsal.MouseEnter, LabelGoals.MouseEnter, PictureBoxCards.MouseEnter
    Try
      Me.IsMouseOver = True
    Catch ex As Exception
  ...
  Private Sub Label_MouseLeave(sender As Object, e As EventArgs) Handles LabelName.MouseLeave, LabelDorsal.MouseLeave, LabelGoals.MouseLeave, PictureBoxCards.MouseLeave
    Try
      Me.IsMouseOver = False
    Catch ex As Exception
...
#Region "Interface functions"
  ...
  Private Sub UpdateStatInfoBox()
    Try
      Me.LabelGoals.Text = IIf(Me.Player.Goals > 0, Me.Player.Goals, "")

      If Me.PictureBoxCards.Image Is Nothing Then PictureBoxCards.Image = New Bitmap(PictureBoxCards.ClientSize.Width, PictureBoxCards.ClientSize.Height)
      Using g As Graphics = Graphics.FromImage(PictureBoxCards.Image)
        g.Clear(Color.White)
        Dim rect As Rectangle
        Dim span As Integer = 3
        Dim pieceWidth As Integer = PictureBoxCards.ClientSize.Width / 2
        Dim pieceHeight As Integer = PictureBoxCards.ClientSize.Height
