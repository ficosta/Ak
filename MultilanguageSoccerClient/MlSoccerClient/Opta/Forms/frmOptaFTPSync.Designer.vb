...
Partial Class frmOptaFTPSync
  ...
  Private Sub InitializeComponent()
    ...
    Me.MultiFileDownloaderAll = New MlSoccerClient.MultiFileDownloader()
    ...
    Me.MultiFileDownloaderAll.LayoutType = MlSoccerClient.MultiFileDownloader.eLayoutType.Both
