...
Public Class GraphicsScoreLine
  ...
  Private Sub PrepareResultScene(ByRef scene As Scene, home_Result As String, away_Result As String, period_Name As String, show_Logo As Boolean)
    ...
    Try
      ...
      scene.SceneParameters.Add(New SceneParameter("Scoreline_period_Name", Translate(period_Name)))
      scene.SceneParameters.Add("Scoreline_Side_" & gSide & "_Bottom_Sublines_Type_1_Data_01_Text", Translate(period_Name))
    ...
    Try
      Select Case (goal.GoalType)
        ...
        Case MatchInfo.MatchGoal.eGoalType.Own
          goalDescription = (Translate("OWN GOAL"))
        Case MatchInfo.MatchGoal.eGoalType.Penalty
          goalDescription = (Translate("PENALTY"))
      End Select
