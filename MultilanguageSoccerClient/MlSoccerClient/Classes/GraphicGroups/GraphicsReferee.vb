  ...
  Public Function PrepareReferees(gSide As Integer, official As Official) As Scene
    ...
    Try
      ...
      If Not official Is Nothing Then
        ...
        scene.SceneParameters.Add(prefix & "Bottom_Bar_Text_Text_01", Translate("REFEREE"))
        scene.SceneParameters.Add("Lower3rd_Side_1_Bottom_Bar_Text_Text_01", Translate("REFEREE"))
        scene.SceneParameters.Add("Lower3rd_Side_2_Bottom_Bar_Text_Text_01", Translate("REFEREE"))
      End If
