    ...
    Try
      ...
      Select Case gs.ChildGraphicStep.UID
        Case Step0.AllShots.Key
          'All shots
          dataText = Translate("Goals") & " " & Player.Goals & " " & Translate("On Target") & " " & Player.MatchStats.ShotsOn.ToString() & " " & Translate("All shots") & " " & Player.MatchStats.Shots.ToString()
          Exit Select
        Case Step0.FoulsConceded.Key
          'Fouls conceded
          dataText = Translate("Fouls conceded") & " " & Player.MatchStats.Fouls.ToString()
          Exit Select
        Case Step0.Assists.Key
          'Assist
          dataText = Translate("Assists") & " " & Player.MatchStats.Assis.ToString()
          Exit Select
        Case Step0.Saves.Key
          'Saves
          dataText = Translate("Saves") & " " & Player.MatchStats.Fouls.ToString()
          Exit Select
        Case Step0.ShotsAndAssists.Key
          'Shots & assists
          dataText = Translate("shots") & " " & Player.MatchStats.Shots.ToString() & ", " & Translate("Assists") & Player.MatchStats.Assis.ToString() & " "
          Exit Select
        Case Else
          'Opta
