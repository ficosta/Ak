...
#Region "Full frame scenes"
  ...
  Public Function PrepareLeagueTable(gSide As Integer, isTop As Boolean, showArrows As Boolean) As Scene
    ...
    Try
      ...
      scene.SceneParameters.Add("Title_Side_" & gSide & "_Team_Right_Text", "")
      scene.SceneParameters.Add("Title_Side_" & gSide & "_Team_Left_Text", "")
      scene.SceneParameters.Add("Title_Side_" & gSide & "_Table_Text", Translate("LEAGUE TABLE"))
  ...
  Public Function PrepareMatchScores(gSide As Integer, matchDay As OtherMatchDay) As Scene
    ...
    Try
      ...
      scene.SceneParameters.Add("Title_Side_" & gSide & "_Vis.active ", "1")
      scene.SceneParameters.Add("Title_Side_" & gSide & "_Control_OMO_GV_Choose ", "0")
      scene.SceneParameters.Add("Title_Side_" & gSide & "_Centre_Text", Translate(matchDay.MatchDayName))
      scene.SceneParameters.Add("Title_Side_" & gSide & "_Right_Text", "")
      scene.SceneParameters.Add("Title_Side_" & gSide & "_Left_Text", "")
      scene.SceneParameters.Add("Title_Side_" & gSide & "_Team_Right_Text", "")
      scene.SceneParameters.Add("Title_Side_" & gSide & "_Team_Left_Text", "")
      ...
      For i As Integer = 0 To statNames.Count - 1
        ...
        Select Case statNames(i)
          Case "Cards"
            ...
            scene.SceneParameters.Add(subjectPrefix & "Team_Name", Translate("CARDS"))
          ...
          Case Else
            ...
            If Not stat Is Nothing Then
              scene.SceneParameters.Add(subjectPrefix & "Team_Name", Translate(stat.StatTitle))
  ...
  Public Function PrepareLeagueComparisson(gSide As Integer) As Scene
    ...
    Try
      ...
      scene.SceneParameters.Add(subjectPrefix & "Team_Name", Translate("POSITION"))
      ...
      scene.SceneParameters.Add(subjectPrefix & "Team_Name", Translate("GAMES"))
      ...
      scene.SceneParameters.Add(subjectPrefix & "Team_Name", Translate("WINS"))
      ...
      scene.SceneParameters.Add(subjectPrefix & "Team_Name", Translate("DRAWS"))
      ...
      scene.SceneParameters.Add(subjectPrefix & "Team_Name", Translate("LOST"))
      ...
      scene.SceneParameters.Add(subjectPrefix & "Team_Name", Translate("GOAL DIFFERENCE"))
      ...
      scene.SceneParameters.Add(subjectPrefix & "Team_Name", Translate("POINTS"))
