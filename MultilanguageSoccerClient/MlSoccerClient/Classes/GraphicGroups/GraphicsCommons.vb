...
#Region "Crawl scenes"
  ...
  Public Function PrepareCommons(gSide As Integer) As Scene
    ...
    Try
      ...
      scene.SceneParameters.Add(prefix & "Bottom_Bar_Text_Text_01", VizEncoding(Translate("COMMENTATORS")))
      scene.SceneParameters.Add("Lower3rd_Side_1_Bottom_Bar_Text_Text_01", VizEncoding(Translate("COMMENTATORS")))
      scene.SceneParameters.Add("Lower3rd_Side_2_Bottom_Bar_Text_Text_01", VizEncoding(Translate("COMMENTATORS")))
      scene.SceneParameters.Add("Lower3rd_Side_" & gSide & "_Bottom_Bar_Text_Text_01 ", VizEncoding(Translate("COMMENTATORS")))
