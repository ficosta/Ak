  ...
  Public Overrides Function PrepareScene(graphicStep As GraphicStep) As Scene
    ...
    Try
      With Me.Scene
        ...
        .SceneDirectorsIn.Add("anim_Clock_Penalties", 0, DirectorAction.Start)

        .SceneDirectorsOut.Add("anim_Clock_Penalties", 0, DirectorAction.ContinueNormal)
