...
#Region "Preview controls"
  ...
  Private Sub GetPreview(ByVal escena As Scene)
    If Not _previewControl Is Nothing Then _previewControl.NewAsset(escena)
  End Sub

  Private Sub GetPreview(ByVal escena As Scene, ByRef pic As PictureBox)
    If Not _previewControl Is Nothing Then _llistaPreviewRequests.Add(New PreviewRequest(_previewControl.NewAsset(escena), pic))
  End Sub
