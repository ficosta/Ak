...
#Region "Settings"
  Private Sub InitializeSettings()
    Try
      ...
      Me.MetroCheckBoxUseMultiLanguage.Checked = AppSettings.Instance.UseMultiLanguageOutput
  ...
  Private Function AcceptSettings() As Boolean
    ...
    Try
      ...
      AppSettings.Instance.UseMultiLanguageOutput = Me.MetroCheckBoxUseMultiLanguage.Checked
